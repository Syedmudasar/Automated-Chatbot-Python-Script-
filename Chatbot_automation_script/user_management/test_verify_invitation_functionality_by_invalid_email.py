...
class Test20:
    ...
    def test20_Verify_an_error_message_entering_invalid_email(self):
        try:
            ...
            Utility.explicit_Wai1t(HrBot_Config_mapper.hrbot_locators.get('conversation_reports'), 'visibility', self.driver)
            ...
            element = self.driver.find_element_by_xpath(
                HrBot_Config_mapper.hrbot_locators.get('user_invitation_mail_box'))
            element.send_keys(HrBot_Config_mapper.hrbot_config.get('invalid_mail_id1'))
            ...
            logger.info('En error message displayed ')

        except Exception as e:
            allure.attach(self.driver.get_screenshot_as_png(), 'screenshots', AttachmentType.PNG)
            logger.error('An Error occurred in Verify an error message entering invalid email 20')
            print(e)
