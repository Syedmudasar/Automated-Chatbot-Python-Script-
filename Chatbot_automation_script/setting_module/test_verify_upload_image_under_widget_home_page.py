...
class Test127(unittest.TestCase):
    ...
    def test127_verify_upload_image_under_widget_home_page(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify upload image under widget homepage 127')
            print(e)
            pytest.fail()