...
class Test126(unittest.TestCase):
    ...
    def test126_verify_widget_home_page_clickable_under_setting_module(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify widget homepage clickable under setting module 126')
            print(e)
            pytest.fail()