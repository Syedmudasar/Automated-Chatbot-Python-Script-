...
class Test122(unittest.TestCase):
    ...
    def test122_verify_additional_settings_clickable_under_setting_module(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify additional settings under setting module 122')
            print(e)
            pytest.fail()