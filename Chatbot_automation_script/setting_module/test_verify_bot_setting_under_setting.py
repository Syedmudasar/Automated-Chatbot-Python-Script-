...
class Test120(unittest.TestCase):


    def test120_verify_bot_setting_under_setting_module(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify bot setting under setting module 120')
            print(e)
            pytest.fail()