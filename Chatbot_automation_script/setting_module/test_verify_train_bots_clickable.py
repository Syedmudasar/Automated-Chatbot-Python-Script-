...
class Test130(unittest.TestCase):
    ...
    def test130_verify_train_bots_clickable_under_setting_module(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify train bots clickable under setting module 130')
            print(e)
            pytest.fail()