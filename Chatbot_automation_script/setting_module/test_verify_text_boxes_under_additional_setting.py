...
class Test124(unittest.TestCase):
    ...
    def test124_verify_text_boxes_insert_data_under_additional_settings_(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify text boxes under additional settings of setting module 124')
            print(e)
            pytest.fail()