...
class Test123(unittest.TestCase):
    ...
    def test123_verify_toggles_clickable_under_additional_settings_(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify toggle under additional settings of setting module 123')
            print(e)
            pytest.fail()