...
class Test116(unittest.TestCase):
    ...
    def test116_verify_setting_icon_in_navigation_bar(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify setting icon left side of navigation bar 116')
            print(e)
            pytest.fail()