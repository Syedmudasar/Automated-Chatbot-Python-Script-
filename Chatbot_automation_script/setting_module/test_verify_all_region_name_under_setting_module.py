...
class Test117(unittest.TestCase):
    ...
    def test117_verify_all_region_name_under_setting_module(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify all region name under setting module 117')
            print(e)
            pytest.fail()