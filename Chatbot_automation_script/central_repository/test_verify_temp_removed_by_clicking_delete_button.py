...
class Test60:
    ...
    def test60_verify_temp_removed_by_clicking_delete_button(self):
        try:
            driver = self.driver
            ...
            logger.error('An Exception occurred in test case verify temp removed from temp list by clicking on delete button 60')
            print(e)
