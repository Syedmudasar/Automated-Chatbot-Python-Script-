...
class Test133(unittest.TestCase):
    ...
    def test133_Verify_new_interaction_button_under_flow_repository(self):
        ...
        try:
            ...
            logger.info('An exception occurred in verify new interaction button under flow repository 133')
