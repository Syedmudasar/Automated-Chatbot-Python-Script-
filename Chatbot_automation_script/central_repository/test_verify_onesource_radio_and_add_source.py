...
class Test149(unittest.TestCase):

    def test149_Verify_one_source_radio_and_add_source_on_interaction_page(self):
        ...
        try:
            ...
            logger.info('An exception occurred in verify one source radio button and add source on interaction page flow repository 149')
