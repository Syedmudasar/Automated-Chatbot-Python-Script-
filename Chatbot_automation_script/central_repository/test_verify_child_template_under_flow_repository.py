...
class Test150(unittest.TestCase):
    ...
    def test150_Verify_save_functionality_on_interaction_page(self):
        ...
        try:
            ...
            time.sleep(2)
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('template_input_box')).send_keys(ExcelReader.read_excel1().get('template_title1'))
            logger.info('User has entered template title as :::{}'.format(ExcelReader.read_excel1().get('template_title1')))
            ...
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('add_button')).click()
            logger.info('User has clicked on plus icon to move to interaction page 1')
            ...
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('template_input_box')).send_keys(
                ExcelReader.read_excel1().get('template_title'))
            logger.info(
                'User has entered template title as :::{}'.format(ExcelReader.read_excel1().get('template_title')))
            ...
            time.sleep(2)
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('shuffle_text_box')).send_keys(
                ExcelReader.read_excel1().get('answer_by_shuffle1'))
            logger.info('User has inserted shuffle answer 1')
            ...
            time.sleep(2)
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('upload_image')).send_keys(
                ExcelReader.read_excel1().get('answer_by_image1'))
            logger.info('User has uploaded a image about hr 1')
            ...
            time.sleep(2)
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('enter_video_url')).send_keys(
                ExcelReader.read_excel1().get('answer_by_video1'))
            logger.info('User has entered video url to upload')
            ...
            time.sleep(3)
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('add_image_url')).send_keys(
                ExcelReader.read_excel1().get('answer_by_image1'))
            logger.info('User has entered image url 1')
            ...
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('carousel_video')).send_keys(
                ExcelReader.read_excel1().get('answer_by_video1'))
            logger.info('User has entered video url')
            ...
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('carousal_description')).send_keys(
                ExcelReader.read_excel1().get('hr_description'))
            logger.info('User has entered HR description')

            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('carousel_url')).click()
            logger.info('User has clicked in carousel url')

            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('carousel_url')).send_keys(
                ExcelReader.read_excel1().get('answer_by_url1'))
            logger.info('User has inserted a url')
            ...
            time.sleep(5)
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('quick_reply_input_box1')).send_keys(
                ExcelReader.read_excel1().get('answer_by_quick_reply'))
            logger.info('User has insert quick reply answer into quick reply')
            ...
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('enter_title_name')).send_keys(
                ExcelReader.read_excel1().get('title_name_under_quick'))
            logger.info('User has insert title name into quick reply 1')
            ...
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('one_source_input')).send_keys(
                ExcelReader.read_excel1().get('answer_by_url1'))
            logger.info('User has entered a source into one source')
            ...
            logger.info('An exception occurred in verify create a child template under flow repository 151')
