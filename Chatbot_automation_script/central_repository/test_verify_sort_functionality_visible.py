...
class Test65:
    ...
    def test65_verify_sort_functionality_visible_on_central_repository(self):
        try:
            driver = self.driver
            ...
            logger.error('An Exception occurred in test case verify sort functionality visible on central repository 65')
            print(e)
