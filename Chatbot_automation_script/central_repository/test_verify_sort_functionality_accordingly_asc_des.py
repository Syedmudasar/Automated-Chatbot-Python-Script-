...
class Test66:
    ...
    def test66_verify_sort_functionality_asc_desc_on_central_repository(self):
        try:
            driver = self.driver
            ...
            logger.error('An Exception occurred in test case verify sort functionality on central repository 66')
            print(e)
