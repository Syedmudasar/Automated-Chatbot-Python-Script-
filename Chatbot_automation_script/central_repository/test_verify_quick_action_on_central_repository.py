...
class Test61:
    ...
    def test61_verify_quick_action_icon_on_central_repository(self):
        try:
            driver = self.driver
            ...
            flag = driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('quick_action_icon')).is_displayed()
            assert flag == True
            ...
            logger.error('An Exception occurred in test case verify quick action icon on central repository 61')
            print(e)
