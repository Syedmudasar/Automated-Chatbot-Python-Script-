...
class Test140(unittest.TestCase):
    ...
    def test140_Verify_answer_by_url_on_interaction_page_under_flow_repository(self):
        ...
        try:
            ...
            time.sleep(2)
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('url_input')).send_keys(ExcelReader.read_excel1().get('answer_by_url1'))
            ...
            logger.info('An exception occurred in verify answer by url on interaction page flow repository 140')
