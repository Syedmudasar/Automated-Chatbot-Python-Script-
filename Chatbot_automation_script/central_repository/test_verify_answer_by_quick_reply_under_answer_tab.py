...
class Test146(unittest.TestCase):

    def test146_Verify_answer_by_quick_reply_on_interaction_page_under_flow_repository(self):
        ...
        try:
            ...
            logger.info('An exception occurred in verify answer by quick reply on interaction page flow repository 146')
