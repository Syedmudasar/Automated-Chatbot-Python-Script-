...
class Test41:
    ...
    # to verify that created template visible in repository list

    def test41_verify_created_template_show_in_list(self):
        ...
        try:
            ...
            time.sleep(2)
            driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('template_input_box')).send_keys(ExcelReader.read_excel2().get('template_name1'))
            ...
            logger.error('An Exception occurred in test case verify created template visible or not 41')
            print(e)
