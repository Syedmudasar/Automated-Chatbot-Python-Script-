...
class Test68:
    ...
    def test68_verify_new_folder_button_visible_on_central_repository(self):
        try:
            driver = self.driver
            ...
            logger.error('An Exception occurred in test case verify new folder button on central repository 68')
            print(e)
