...
class Test147(unittest.TestCase):
    ...
    def test147_Verify_add_title_name_on_interaction_page_under_quick_reply(self):
        ...
        try:
            ...
            logger.info('An exception occurred in verify add title name under quick reply on interaction page flow repository 147')
