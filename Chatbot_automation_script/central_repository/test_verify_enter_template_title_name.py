...
class Test141(unittest.TestCase):
    ...
    def test141_Verify_enter_template_name_on_interaction_page_under_flow_repository(self):
        ...
        try:
            ...
            logger.info('An exception occurred in verify enter template name on interaction page flow repository 141')
