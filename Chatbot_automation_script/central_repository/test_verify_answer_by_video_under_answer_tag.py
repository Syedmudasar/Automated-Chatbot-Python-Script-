...
class Test144(unittest.TestCase):

    def test144_Verify_answer_by_videos_on_interaction_page_under_flow_repository(self):
        ...
        try:
            ...
            logger.info('An exception occurred in verify answer by video on interaction page flow repository 144')
