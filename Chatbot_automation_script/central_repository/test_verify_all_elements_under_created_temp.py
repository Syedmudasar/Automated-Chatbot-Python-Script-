...
class Test136(unittest.TestCase):
    ...
    def test36_Verify_all_elements_after_created_temp_under_flow_repository(self):
        ...
        try:
            ...
            logger.info('An exception occurred in verify all elements after created a temp under flow repository 136')
