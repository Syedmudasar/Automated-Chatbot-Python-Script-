...
class Test145(unittest.TestCase):
    ...
    def test145_Verify_answer_by_carousel_on_interaction_page_under_flow_repository(self):
        ...
        try:
            ...
            logger.info('An exception occurred in verify answer by carousel on interaction page flow repository 145')
