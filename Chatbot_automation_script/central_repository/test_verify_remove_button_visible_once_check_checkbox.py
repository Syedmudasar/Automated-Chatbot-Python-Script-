...
class Test58:
    ...
    def test58_verify_remove_button_is_visible_when_check_check_box(self):
        try:
            driver = self.driver
            ...
            logger.error('An Exception occurred in test case verify remove button when user check the check box in central repository 58')
            print(e)
