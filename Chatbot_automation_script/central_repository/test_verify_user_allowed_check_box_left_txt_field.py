...
class Test55:
    ...
    def test55_verify_user_allowed_check_checkBox_left_text_field(self):
        try:
            driver = self.driver
            ...
            logger.error('An Exception occurred in test case verify user allowed check the check box that is in left of text field 55')
            print(e)
