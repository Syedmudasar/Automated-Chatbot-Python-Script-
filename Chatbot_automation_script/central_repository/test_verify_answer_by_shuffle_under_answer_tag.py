...
class Test142(unittest.TestCase):

    def test142_Verify_answer_by_shuffle_on_interaction_page_under_flow_repository(self):
        ...
        try:
            ...
            logger.info('An exception occurred in verify answer by shuffle on interaction page flow repository 142')
