...
class Test113(unittest.TestCase):
    ...
    def test113_verify_import_file_by_searching_into_database(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify import file by search in database  113')
            print(e)
            pytest.fail()