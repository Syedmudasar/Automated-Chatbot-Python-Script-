...
class Test115(unittest.TestCase):
    ...
    def test115_verify_all_elements_on_chat_bots_page_by_selecting_any_region(self):
        ...
        try:
            ...
            if region_name in ['TICA-El Salvador', 'TIC-Canada', 'TIE-Ireland', 'TIE-Romania', 'TIE-United Kingdom', 'TI-Philippines', 'TIUS-USA']:
                ...
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('train_icon')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('import_icon')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('remove_icon')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('export_icon4')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('data_sorting_drop_down')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('setting_icon')).is_displayed()
                logger.info('As expected all elements are visible on chat bots page')

            elif region_name in ['TICA-Guatemala', 'TIE-Bulgaria', 'TII-India']:
                ...
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('train_icon')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('remove_icon')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('update_icon')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('export_icon5'))
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('data_sorting_drop_down')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('setting_icon')).is_displayed()
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('drop_down_select_all_or_unsync')).is_displayed()
                logger.info('As expected all elements are visible on chat bots page')
            ...
            logger.error('An Exception occurred in test case verify all elements select any region from list of region on chat bots page  115')
            print(e)
            pytest.fail()