...
class Test93(unittest.TestCase):

    def test93_verify_all_elements_visible_on_chat_bots_page(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify all elements visible on chat bots page 93')
            print(e)
            pytest.fail()