...
class Test107(unittest.TestCase):
    ...
    def test107_verify_confirmation_pop_up_before_delete_any_interaction(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify confirmation pop up before delete any interaction 107')
            print(e)
            pytest.fail()