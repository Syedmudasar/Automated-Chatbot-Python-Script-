...
class Test106(unittest.TestCase):
    ...
    def test106_verify_select_item_from_drop_down_visible_under_chat_bots(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify select item from drop down under quick action 106')
            print(e)
            pytest.fail()