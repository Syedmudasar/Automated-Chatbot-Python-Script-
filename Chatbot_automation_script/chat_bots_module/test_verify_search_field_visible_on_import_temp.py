...
class Test97(unittest.TestCase):

    def test97_verify_search_field_visible_on_import_template_page(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify search field visible on import template pop up page or not 97')
            print(e)
            pytest.fail()