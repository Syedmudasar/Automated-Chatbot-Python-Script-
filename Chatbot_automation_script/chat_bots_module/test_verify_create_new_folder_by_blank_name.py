...
class Test100(unittest.TestCase):
    ...
    def test100_verify_add_new_folder_by_blank_name_on_chat_bots_page(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify create new folder leaving blank input box 100')
            print(e)
            pytest.fail()