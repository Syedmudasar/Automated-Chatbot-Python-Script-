...
class Test94(unittest.TestCase):
    ...
    def test94_verify_select_any_region_on_chat_bots_page(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify select any region displayed on chat bots page 94')
            print(e)
            pytest.fail()