...
class Test96(unittest.TestCase):

    def test96_verify_import_button_works_on_chat_bots_page(self):
        ...
        try:
            ...
            logger.error('An Exception occurred in test case verify import button works or not 96')
            print(e)
            pytest.fail()