...
class Test103(unittest.TestCase):
    ...
    def test103_verify_delete_folder_under_quick_action_on_chat_bots_page(self):
        ...
        try:
            ...
            for names in list_folder_names1:
                ...
                if folder == names:
                    ...
                    try:
                        ...
                        time.sleep(4)
                        path2 = HrBot_Config_mapper.hrbot_locators.get('delete_folder1')
            ...
            logger.error('An Exception occurred in test case verify delete  folder under quick action 103')
            print(e)
            pytest.fail()