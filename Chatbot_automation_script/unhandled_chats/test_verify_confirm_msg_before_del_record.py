...
class Test80(unittest.TestCase):
    ...
    def test80_verify_confirmation_msg_before_delete_records(self):
        ...
        try:
            ...
            if flag:
                ...
                driver.find_element_by_xpath(
                    HrBot_Config_mapper.hrbot_locators.get('confirmation_message')).is_displayed()
            ...
            logger.info('An Exception occurred in test case verify confirmation message before delete unhandled records 80')
            print(e)
            pytest.fail()
