    ...
    def test77_verify_delete_records_in_unhandled_message(self):
        ...
        try:
            ...
            if not flag:
                ...
                time.sleep(3)
                driver.find_element_by_xpath(HrBot_Config_mapper.hrbot_locators.get('assign_interaction')).is_displayed()
            ...
            logger.info('An Exception occurred in test case verify assign unhandled records 77')
            print(e)
            pytest.fail()
